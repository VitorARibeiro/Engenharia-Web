...
namespace Aula3.Controllers
{
    ...
    {
        private readonly Aula3Context _context;

        public CoursesController(Aula3Context context)
        {
            _context = context;
        }
        ...
        {
            var aula3Context = _context.Course.Include(c => c.Category);
            return View(await aula3Context.ToListAsync());
        }
